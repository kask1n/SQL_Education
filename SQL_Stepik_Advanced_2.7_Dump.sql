DROP SCHEMA IF EXISTS stepik_advanced_2_7;
CREATE SCHEMA stepik_advanced_2_7;
USE stepik_advanced_2_7;
...
VALUES ('Двенадцать стульев', 1, 3, 2018, 1),
       ...
       ('Вокруг света за 80 дней', 2, 5, 2019, 7),
       ...
       ('Стихи', 4, 1, 2019, 6),
       ('Поэмы', 4, 6, 2020, 8),
       ('Герой нашего времени', 1, 6, 2017, 3),
       ('Стихи', 4, 3, 2017, 5),
...
VALUES ('Вокруг света за 80 дней', 'ДРОФА', 2019, 2),
